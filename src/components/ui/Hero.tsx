...
const Hero = () => {
  ...
  return (
    <div 
      className="flex min-h-screen items-center justify-center p-4 relative bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: 'url(/images/meetings/meeting-9.jpeg)',
      }}
    >
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-background/80 to-muted/30 z-0"></div>
      ...
      <div className="text-center max-w-2xl mx-auto space-y-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div 
            className="p-6 rounded-lg border border-border hover:border-brand-blue/50 transition-all duration-300 hover:scale-105 cursor-pointer bg-card/80 backdrop-blur-sm"
          ...
          <div 
            className="p-6 rounded-lg border border-border hover:border-cyber-accent/50 transition-all duration-300 hover:scale-105 cursor-pointer bg-card/80 backdrop-blur-sm"
